  ...
  return (
    <main className="flex-1">
      ...
      <section className="relative overflow-hidden bg-gradient-to-br from-emerald-700 via-emerald-800 to-emerald-900 py-24 text-white">
        <div className="mx-auto max-w-3xl px-6 text-center">
          ...
          <h1 className="text-4xl font-bold sm:text-5xl">
            Werden Sie <span className="text-emerald-300">Ortskasse-Partner</span>
          </h1>
      ...
      <section className="bg-white py-20">
        <div className="mx-auto max-w-3xl px-6">
          <h2 className="text-center text-3xl font-bold text-stone-900">Warum Ortskasse?</h2>
            ...
            <table className="w-full text-sm">
              <thead>
                <tr className="bg-stone-100">
                  ...
                  <th className="px-4 py-3 text-center font-bold text-emerald-700">Ortskasse</th>
